...
<div class="max-w-3xl mx-auto py-6">
    <h1 class="text-2xl font-bold mb-6">Categorie bewerken</h1>

    <form action="{{ route('admin.faq.update-category', $category) }}" method="POST" class="space-y-4 bg-white p-6 rounded shadow">
        @csrf
        @method('PUT')
